...
import { ArrowUpDown, MessageSquare, MoreHorizontal, Plus } from 'lucide-react';
...
export default function SmsCampaigns() {
  ...
  const smsCampaigns = campaigns?.filter(campaign => campaign.type === 'sms') || [];
  ...
  const columns: ColumnDef<Campaign>[] = [
    ...
    },
    {
      ...
      header: 'Scheduled',
      cell: ({ row }) => formatDate(row.getValue('scheduled_at') || ''),
    },
    {
